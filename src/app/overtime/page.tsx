...
import { ArrowLeft, Clock, Calendar, Archive, Loader2, BarChart2, Calendar as CalendarIcon } from 'lucide-react';
...
export default function OvertimeDashboardPage() {
  ...
  const monthlyData = useMemo(() => {
    ...
    return { 
      ...
      chartData: summary.map(s => ({ name: s.employeeName, [t('overtime')]: s.totalAmount }))
    };
  }, [isLoading, selectedDate, overtime, employees, t]);
