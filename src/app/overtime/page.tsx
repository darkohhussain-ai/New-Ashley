...
import { ArrowLeft, Clock, Calendar, Archive, BarChart as BarChartIcon, Printer, FileDown } from 'lucide-react';
...
function OvertimeDashboardPage() {
  ...
  const handleDownloadPdf = async () => {
    ...
    pdf.save(`overtime-summary-${format(selectedDate || new Date(), 'yyyy-MM')}.pdf`);
  };
