...
import { ArrowLeft, Plus, Trash2, Edit, Save, X, Loader2, FileDown } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background text-foreground p-4 md:p-8">
      ...
      <header className="flex items-center justify-between gap-4 mb-8">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl md:text-3xl font-bold">{t('waiting_list')}</h1>
        </div>
                    ...
                    {selectedList ? (
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-2">
                            <Button variant="outline" onClick={handleExportPdf}><FileDown className="mr-2 h-4 w-4" />{t('export_pdf')}</Button>
