  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col bg-black overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 w-full bg-background/80 backdrop-blur-xl border-b border-primary/20 shadow-2xl">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xs font-bold uppercase tracking-widest text-primary">ASHLEY STAFF</h1>
          </div>
          ...
          <form onSubmit={handleLogin} className="flex items-center gap-2">
            <div className="hidden md:flex items-center gap-2">
              <Input
                ...
                className="h-9 w-32 bg-muted/50 border-primary/10 text-[10px]"
                required
              />
              <Input
                type="password"
            ...
            <Button 
              type="submit" 
              size="sm" 
              className="h-9 px-6 font-bold uppercase text-[10px]"
              disabled={isLoading}
            >
      ...
      <main className="relative z-10 flex-1 w-full max-w-7xl mx-auto p-4 md:p-8 flex flex-col justify-center gap-12">
        <section className="text-center space-y-10 py-12">
          <h2 className="text-4xl md:text-6xl font-bold tracking-tight text-white uppercase">
            ASHLEY <span className="text-primary">STAFF</span>
          </h2>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Dialog onOpenChange={(open) => !open && setActiveTransmissionCity(null)}>
              <DialogTrigger asChild>
                <Button size="lg" className="h-16 px-12 bg-primary/20 backdrop-blur-md border border-primary/30 hover:bg-primary/40 text-primary font-bold uppercase tracking-widest text-[11px] shadow-2xl transition-all">
                  <ListChecks className="mr-3 w-6 h-6" />
                  Transmission Lists
                </Button>
              </DialogTrigger>
              <DialogContent className="max-w-4xl bg-card/68 backdrop-blur-xl border-primary/20 max-h-[85vh] overflow-hidden flex flex-col p-0">
                <header className="p-6 pb-2">
                  <DialogTitle className="text-lg uppercase flex items-center gap-2">
                    ...
                    {activeTransmissionCity || "Select Regional Node"}
                  </DialogTitle>
                </header>
                ...
                <div className="flex-1 overflow-hidden p-6 pt-2 flex flex-col">
                  {!activeTransmissionCity ? (
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 py-4">
                      {["Erbil", "Baghdad", "Diwan", "Dohuk"].map((city) => (
                        <Button 
                          key={city} 
                          variant="outline" 
                          className="h-20 bg-muted/10 border-primary/10 hover:border-primary/40 hover:bg-primary/5 flex items-center justify-between px-8 text-base font-bold uppercase tracking-tight group"
                    ...
                    <div className="flex flex-col h-full space-y-4">
                      ...
                      >
                        <ArrowLeft className="mr-2 w-3 h-3" /> Back to cities
                      </Button>
                        ...
                        <div className="max-h-[50vh] overflow-auto">
                          <Table>
                            <TableHeader className="bg-primary/10 sticky top-0 z-10">
                              <TableRow>
                                <TableHead className="w-[50px] text-[9px] uppercase font-bold">Audit</TableHead>
                                ...
                                <TableRow>
                                  <TableCell colSpan={4} className="h-48 text-center">
                                    <div className="flex flex-col items-center justify-center space-y-3 opacity-20">
                                      ...
                                      <p className="text-[10px] font-bold uppercase tracking-widest">No Active Cargo</p>
                                    </div>
                                  </TableCell>
                                </TableRow>
                              )}
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Button size="lg" variant="outline" className="h-16 px-12 bg-white/5 backdrop-blur-md border-white/10 hover:bg-white/10 text-white font-bold uppercase tracking-widest text-[11px] shadow-2xl transition-all">
              ...
              <DialogContent className="max-w-3xl bg-card/68 backdrop-blur-xl border-primary/20 max-h-[85vh] overflow-hidden flex flex-col">
                <header>
                  <DialogTitle className="text-lg uppercase flex items-center gap-2">
                    <Search className="w-5 h-5 text-primary" /> Global Location Search
                  </DialogTitle>
                </header>
                ...
                <div className="space-y-6 pt-4 flex-1 flex flex-col overflow-hidden">
                  <div className="relative">
                    ...
                    <Input 
                      placeholder="ENTER MODEL NAME TO AUDIT..." 
                      value={locationSearchQuery}
                      onChange={(e) => setLocationSearchQuery(e.target.value)}
                      className="h-14 pl-12 bg-muted/20 border-primary/20 text-[11px] font-bold uppercase tracking-widest"
                    />
                  </div>
                            ...
                            <TableRow>
                              <TableCell colSpan={3} className="h-64 text-center">
                                <div className="flex flex-col items-center justify-center space-y-4 opacity-20">
                                  ...
                                  <p className="text-[10px] font-bold uppercase tracking-widest">Enter model name</p>
                                </div>
                              </TableCell>
                            </TableRow>
                          )}
      ...
      <footer className="relative z-10 py-8 text-center border-t border-white/5 bg-black/40">
        <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground opacity-30">
