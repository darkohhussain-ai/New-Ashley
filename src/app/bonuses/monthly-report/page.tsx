...
import { ArrowLeft, Calendar as CalendarIcon, FileText, BarChart, Printer, FileDown } from 'lucide-react';
...
export default function MonthlyBonusReportPage() {
  ...
  const monthlyData = useMemo(() => {
    ...
    const chartData = summary.map(item => ({
        ...
        [t('total_bonus')]: item.totalAmount,
    }));

    return { records: filteredRecords, summary, totalAmount, totalLoads, chartData };
