...
export function ReportWrapper({ title, date, logoSrc, themeColor = '#333333', children }: ReportWrapperProps) {
  ...
  return (
    <div className={cn("bg-white text-black p-6 font-sans text-xs leading-normal w-full", useKurdish && "font-sans")} style={{fontFamily: 'var(--font-body)'}} dir={useKurdish ? 'rtl' : 'ltr'}>
        {/* Header */}
