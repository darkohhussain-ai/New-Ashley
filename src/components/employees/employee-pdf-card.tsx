...
export function EmployeePdfCard({ employee, logoSrc }: EmployeePdfCardProps) {
  ...
  return (
    <div className="bg-white text-gray-800 w-[500px] font-sans rounded-lg shadow-lg overflow-hidden border border-gray-200" style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
      {/* Header Section */}
      <div className="relative h-28 bg-orange-400">
         <div
          ...
          ></div>
        <div className="absolute top-1/2 -translate-y-1/2 right-6 flex items-center justify-center bg-white rounded-full w-24 h-24 shadow-md">
      ...
      <div className="relative bg-white px-6 pb-6">
          ...
          {/* Details Grid */}
          <div className="mt-8 grid grid-cols-6 gap-x-4 gap-y-4 text-xs border-t pt-6">
              <div className="col-span-2"><p className="text-gray-500">ID No</p><p className="font-semibold">{employee.id.substring(0, 7).toUpperCase()}</p></div>
              <div className="col-span-2"><p className="text-gray-500">Joined Date</p><p className="font-semibold">{formattedJoinedDate}</p></div>
              <div className="col-span-2"><p className="text-gray-500">Email</p><p className="font-semibold truncate">{employee.email || 'N/A'}</p></div>
              
              <div className="col-span-2"><p className="text-gray-500">D.O.B</p><p className="font-semibold">{formattedDob}</p></div>
              <div className="col-span-2"><p className="text-gray-500">Expire Date</p><p className="font-semibold">N/A</p></div>
